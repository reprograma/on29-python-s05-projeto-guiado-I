...
digitar o mês e receber a receita desse mês
1 - captar o mês que ele quer
2 - buscar no dataset o registro com o mẽs escolhido pelo usuário
...
maior_receita = 13515 / ano 2024

1 2022 -- receita: -23134
2 2023 -- receita: -33711
3 2024 -- receita: 13515

1 - verificar a receita e o ano;
2 - se a receita for maior que o último valor, substitua.
...
def adicionar_registro():
    ...
    lucro = int(input("digite luccro neste mês: "))
    gastos = int(input("digite o gasto deste mês: "))
...
def mostrar_receita():
    ...
    print(f"o ano {ano}, foi o ano mais lucrativo deste mês, e o valor foi {receita_maior}")
    print(f"o ano {ano_menor_receita}, foi o ano menos lucrativo deste mês, e o valor foi {receita_menor}")
    print(f"Sua Receita Total para o mês escolhido é: {valor_total}")
